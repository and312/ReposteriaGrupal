 ...
 * @author sound
 */
public class InterfazClase extends javax.swing.JFrame {
    
    private List<JButton> botones;
    private int indice;

    public InterfazClase() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jButton2.setText("Inicio docente");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        InterfazCrearClase ventanaCrearClase = new InterfazCrearClase();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InterfazClase.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new InterfazClase().setVisible(true);
            }
        });
    }
